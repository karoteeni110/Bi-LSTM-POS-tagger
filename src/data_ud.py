...
# TRAIN_FPATH =  join(data_path,'fi_tdt-ud-train.conllu.txt')
# TEST_FPATH =  join(data_path,'fi_tdt-ud-test.conllu.txt')
# DEV_FPATH =  join(data_path,'fi_tdt-ud-dev.conllu.txt')

TRAIN_FPATH = join(data_path, 'sv_talbanken-ud-train.conllu.txt')
TEST_FPATH =  join(data_path,'sv_talbanken-ud-test.conllu.txt')
DEV_FPATH =  join(data_path,'sv_talbanken-ud-dev.conllu.txt')

# TRAIN_FPATH =  join(data_path,'de_hdt-ud-train.conllu.txt')
# TEST_FPATH =  join(data_path,'de_hdt-ud-test.conllu.txt')
# DEV_FPATH =  join(data_path,'de_hdt-ud-train.conllu.txt')
...
if __name__=="__main__":
    ...
    print(token_to_freq.most_common()[:10])
